...
Esse é um projeto pessoal idealizado por mim com o intuito de desenvolver habilidades utilizando a linguagem Python de forma pura.
A ideia é desenvolver o raciocínio lógico sem depender de biblitecas externas.

O Objetivo em questão é replicar o jogo Xadrez, possibilitando jogar através do terminal de comando. O jogo deve ser replicado de maneira integral (Ou quase), respeitando as regras e as nuances do jogo.
